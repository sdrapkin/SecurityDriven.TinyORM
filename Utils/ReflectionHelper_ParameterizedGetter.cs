...
namespace SecurityDriven.TinyORM.Utils
{
	public static class ReflectionHelper_ParameterizedGetter<T> where T : class
	{
		...
		public static readonly Dictionary<string, Func<T, (object, Type)>> Getters = ReflectionHelper_Shared.GetPropertyGetters<T>(type: _typeofT, prefix: ReflectionHelper_Shared.PARAM_PREFIX);
